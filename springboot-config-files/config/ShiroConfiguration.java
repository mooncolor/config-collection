...
import com.cms.kernel.credentials.LoginCredentialsMatcher;
import com.cms.kernel.filter.LoginFormAuthenticationFilter;
import com.cms.kernel.realm.UserRealm;
...
//        SecurityUtils.setSecurityManager(securityManager);
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/front/user/login");
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl("/index.jsp");
        // 未授权界面;
        shiroFilterFactoryBean.setUnauthorizedUrl("/common/html/403.html");
        ...
        filterChainDefinitionMap.put("/front/user/login","authc");
 ...
 /*   @Bean
    ...
    public UserRealm userRealm(){
        ...
        userRealm.setCredentialsMatcher(new LoginCredentialsMatcher());
        return userRealm;
    }
